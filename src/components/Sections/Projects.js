...
const Projects = props => {
    ...
    <div id="projects" className="card text-center shadow">
        <div className="overflow">
            <a href={props.link} target="_blank" rel="noopener noreferrer" ><img src={props.imgsrc} alt="mountain" className="card-img-top"/></a>
        </div>
        <div className="card-body text-dark">
            ...
            <a href={props.link} target="_blank" rel="noopener noreferrer" className="btn btn-outline-success">Go Anywhere</a>
        </div>
    </div>
    );
};
